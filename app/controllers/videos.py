...
@auth.login_required
@controllers.route("/video/directory/<directory>/", methods=["GET"])
...
@auth.login_required
@controllers.route("/video/<int:id>/", methods=["GET"])
...
@auth.login_required
@controllers.route("/video/name/<name>/", methods=["GET"])
